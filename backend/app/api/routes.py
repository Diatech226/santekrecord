...
def audio_diagnostics(engine=Depends(get_engine)):
    ...
    return {
        ...
        "stream_opened": bool(engine.source and engine.source.is_active),
        "frames_received": telemetry["frames_received"],
        "last_frame_ms": telemetry["last_audio_frame_ms"],
        "last_audio_frame_ms": telemetry["last_audio_frame_ms"],
        ...
        "raw_level_dbfs": telemetry.get("raw_level_dbfs"),
        "raw_peak_dbfs": telemetry.get("raw_peak_dbfs"),
        ...
        "speech_probability": telemetry.get("speech_probability"),
        "speech_candidate": telemetry.get("speech_candidate"),
        "speech_confirmed": telemetry.get("speech_confirmed"),
        "raw_ambient_ready": telemetry.get("raw_ambient_ready"),
        "raw_noise_floor_dbfs": telemetry.get("raw_noise_floor_dbfs"),
